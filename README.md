...
* **Own the full feature lifecycle** — from idea → architecture → implementation → optimization
* Prefer **simple, scalable systems** over over-engineered solutions
* Optimize for **real-world constraints**: latency, battery, and reliability
...
* Implemented **on-device ML inference** for offline usability
